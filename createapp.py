...
def createapp():
    ...
    cursor.execute(f"insert into appointments values ({app_id},'{app_date}','{app_time}','{pname}',{scheduled},{canceled},{completed},'{specialization}','{department}','{patientid}','{doctorid}')")
